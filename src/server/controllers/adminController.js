...
const createAdmin = async (req, res) => { // eslint-disable-line
  const {
  ...
  try {
    ...
    const token = generateUserToken(dbResponse.email,
      dbResponse.id, dbResponse.is_admin, dbResponse.first_name, dbResponse.last_name)
